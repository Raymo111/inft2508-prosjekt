...
const ItemCard = (props: {
  ...
  const height = props.item.images ? props.item.images[0].height : 200

  return (
    <Pressable style={Styles.card.card} onPress={handlePress}>
      <Image source={{uri: props.item.images ? props.item.images[0].url : endpoint + 'item-placeholder.png'}} style={Styles.card.image} height={200}
